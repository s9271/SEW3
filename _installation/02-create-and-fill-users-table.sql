CREATE TABLE IF NOT EXISTS `login`.`users` (
  ...
  `user_name` varchar(64) COLLATE utf8_general_ci NOT NULL COMMENT 'user''s name, unique',
  `user_password_hash` varchar(255) COLLATE utf8_general_ci NOT NULL COMMENT 'user''s password in salted and hashed format',
  `user_email` varchar(64) COLLATE utf8_general_ci NOT NULL COMMENT 'user''s email, unique',
  PRIMARY KEY (`user_id`),
