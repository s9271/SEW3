<div id="soldier_schools_list" class="new_admin_tpl m_table_list soldier_children_list">
                        ...
                        <td class="table_akcje">
                            ...
                            <form method="post">
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <button class="btn btn-danger jsconfirm" data-confirm="<?php echo htmlspecialchars($item['name']); ?>: Czy na pewno chcesz usunąć szkołęwyższą żołnierza?" type="submit" name="form_action" value="school_delete">Usuń</button>
                                </div>
