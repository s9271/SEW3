<div id="soldier_address_form" class="container mar_custom">
    <div class="jumbotron">
        ...
        <form method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label for="form_country">*Państwo:</label>
                    <input name="form_country" type="text" class="form-control input-sm" id="form_country" placeholder="Państwo" required="required" value="<?php echo ((isset($this->tpl_values['form_country']) && $this->tpl_values['form_country'] != '') ? $this->tpl_values['form_country'] : ''); ?>" />
                </div>
            </div>
