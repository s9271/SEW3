<div id="soldier_missions_form" class="new_admin_tpl mar_custom">
    ...
    <form method="post" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-6">
                <label for="form_date">*Data oddelegowania:</label>
                <input name="form_date" type="text" class="form-control input-sm jsdatetime" id="form_date" placeholder="Data oddelegowania" required="required" value="<?php echo ((isset($this->tpl_values['form_date']) && $this->tpl_values['form_date'] != '') ? $this->tpl_values['form_date'] : ''); ?>" />
