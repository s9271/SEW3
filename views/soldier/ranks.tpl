<div id="soldier_ranks_list" class="new_admin_tpl m_table_list soldier_children_list mar_custom">
                        ...
                        <td class="table_akcje">
                            ...
                            <form method="post">
                                ...
                                <div class="btn-group btn-group-sm">
                                    <button class="btn btn-danger jsconfirm" data-confirm="<?php echo htmlspecialchars($item['name']); ?>: Czy na pewno chcesz usunąć stopień wojskowy?" type="submit" name="form_action" value="rank_delete">Usuń</button>
                                </div>
