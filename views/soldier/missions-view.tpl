<div id="soldier_missions_view" class="new_admin_tpl mar_custom">
    ...
    <div class="row margin_top_15">
        <div class="col-sm-12">
            ...
            <form method="post" class="pull-right">
                ...
                <button class="btn btn-danger jsconfirm" data-confirm="Czy na pewno chcesz usunąć to powiązanie misji z żołnierzem?" type="submit" name="form_action" value="mission_delete"><span class="glyphicon glyphicon-trash"></span> Usuń powiązanie</button>
            </form>
