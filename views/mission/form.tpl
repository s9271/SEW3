    ...
    <div class="jumbotron">
        ...
        <form method="post" action="" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="form_location" class="form-control login_input input-sm" type="text" placeholder="Lokalizacja misji" name="form_location" required="required" value="<?php echo ((isset($this->tpl_values['form_location']) && $this->tpl_values['form_location'] != '') ? $this->tpl_values['form_location'] : ''); ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="form_date_start" class="form-control login_input input-sm form_datepicker" type="text" placeholder="Data rozpoczęcia" name="form_date_start" required="required" value="<?php echo ((isset($this->tpl_values['form_date_start']) && $this->tpl_values['form_date_start'] != '') ? $this->tpl_values['form_date_start'] : ''); ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="form_date_end" class="form-control login_input input-sm form_datepicker" type="text" placeholder="Data zakończenia" name="form_date_end" required="required" value="<?php echo ((isset($this->tpl_values['form_date_end']) && $this->tpl_values['form_date_end'] != '') ? $this->tpl_values['form_date_end'] : ''); ?>" />
                </div>
            </div>
