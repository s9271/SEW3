  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a href="user.php"><span class="glyphicon glyphicon-plus"></span>&emsp;Użytkownik&emsp;|</a></li>
          ...
          <ul class="sidebar-nav">
              ...
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu ">
                    <li><a href="user.php"><span class="glyphicon glyphicon-plus"></span>&emsp;&emsp;Dodaj Użytkownika</a></li>
                    <li><a href="user.php?action=list"><span class="glyphicon glyphicon-list-alt"></span>&emsp;&emsp;Pokaż Użytkowników</a></li>
                  </ul>
              </li>
              <li class="dropdown">
              ...
              <li class="dropdown">
                  <a class="dropdown-toggle" data-toggle="dropdown" href="equipment.php"><span class="glyphicon glyphicon-list-alt"></span>&emsp;&emsp;Ekwipunek<span class="caret"></span></a>
                  <ul class="dropdown-menu sidebar-nav">
                    <li><a href="equipment.php"><span class="glyphicon glyphicon-plus"></span>&emsp;&emsp;Dodaj Ekwipunek</a></li>
                    <li><a href="equipment.php?action=list"><span class="glyphicon glyphicon-list-alt"></span>&emsp;&emsp;Pokaż Ekwipunek</a></li>
                  </ul>
              </li>
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu sidebar-nav">
                    <li><a href="#"><span class="glyphicon glyphicon-plus"></span>&emsp;&emsp;Dodaj Szkolenie</a></li>
                    <li><a href="#"><span class="glyphicon glyphicon-list-alt"></span>&emsp;&emsp;Pokaż Szkolenia</a></li>
                  </ul>
              </li>
              <li class="dropdown">
                  <a class="dropdown-toggle" data-toggle="dropdown" href="mission.php"><span class="glyphicon glyphicon-screenshot"></span>&emsp;&emsp;Misje<span class="caret"></span></a>
                  <ul class="dropdown-menu sidebar-nav">
