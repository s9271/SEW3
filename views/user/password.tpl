    ...
    <form method="post" class="form-horizontal">
        ...
        <div class="form-group margin_top_50">
            <div class="col-sm-12 text-right">
                ...
                <a href="/uzytkownicy/edytuj/<?php echo $this->tpl_values['id_user']; ?>" class="btn btn-warning mar_button"><span class="glyphicon glyphicon-chevron-left"></span>Powrót do edycji użytkownika</a>
