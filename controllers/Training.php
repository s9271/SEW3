...
class Training
{
    ...
    public function __construct()
    {
        ...
        switch ($_action) {
            case 'create':
                ...
                include("views/training/create.php");
                break;
            ...
            // update item to DB
                ...
                include("views/training/update.php");
                break;
    ...
    {
        if (empty($_POST['trainingLocation']) || empty($_POST['trainingName']) ) {
            ...
            if (!$this->db_connection->connect_errno) {
               ...
               // $trainingNumber = $this->db_connection->real_escape_string(strip_tags($_POST['trainingNumber'], ENT_QUOTES));
                $trainingName = $this->db_connection->real_escape_string(strip_tags($_POST['trainingName'], ENT_QUOTES));
                $trainingLocation = $this->db_connection->real_escape_string(strip_tags($_POST['trainingLocation'], ENT_QUOTES));
                $trainingDate = $this->db_connection->real_escape_string(strip_tags($_POST['trainingDate'], ENT_QUOTES));
                $trainingDate1 = $this->db_connection->real_escape_string(strip_tags($_POST['trainingDate1'], ENT_QUOTES));


                // write new item data into database
                $sql = "INSERT INTO training
                          (trainingName, trainingLocation, trainingDate, trainingDate1)
                        VALUES
                          ('"  . $trainingName . "', '" . $trainingLocation . "',
...
//        $this->redirectToMainPage();
    ...
    public function getAllItems()
    {
        ...
        // draw view
        include("views/training/list.php");
        return;
    }
    ...
    private function redirectToMainPage()
    {
        ...
        $extra = 'training.php?action=list';
