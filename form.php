...
if (isset($SoldierAdd)) {
    if ($SoldierAdd->errors) {
        foreach ($SoldierAdd->errors as $error) {

        }
    }
    if ($SoldierAdd->messages) {
        foreach ($SoldierAdd->messages as $message) {
            echo $message;
        }
    }
}
...
<div class="container" >
  <div class="jumbotron">
    <div class="alert alert-success fade in">
      <form method="post" action="SoldierAdd.php" name="form" class="form-horizontal">
