        ...
        public function addCustomValidate()
        {
            ...
            if($soldier_missions)
            {
                foreach($soldier_missions as $soldier_mission)
                {
                    ...
                    if(self::checkInterferingDates($soldier_mission['date_start'], $item->date_start, $soldier_mission['date_end'], $item->date_end)){
            ...
            if($soldier_trainings)
            {
                ...
                {
                    // sprawdzanie czy nowa misja koliduje z jakas inna misja, na ktorej zolnierz jest
                    if(self::checkInterferingDates($soldier_training['date_start'], $item->date_start, $soldier_training['date_end'], $item->date_end)){
